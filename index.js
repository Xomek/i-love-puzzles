// Работа функции encode (для меня)
// 0. Превращаем строку в массив.
// 1. Приводим массив к виду "массив маиссовов", где первым будет код строки, а вторым индекс строки.
// 2. Сортируем.
// 3. Разворачиваем все массивы.
// 4. Приводим к строке где каждый элемент массива будет через точку.
// 5. Возвращает массив всех символов в строке. В данном случае, используется регулярное выражение ".", которое соответствует любому символу, поэтому метод .match(/./g) вернет массив всех символов в строке.
// 6. Если x = . возвращаем 1 иначе 2 + x * 2.fill((1 + i) % 2))
// 7. Приводим массив к строке
// 8. Это регулярное выражение ищет последовательности из нулей и единиц и заменяет их на строку, которая начинается с точки или минуса в зависимости от того, является ли первый символ в последовательности нулем или единицей, а затем следует длина последовательности. Например, "001100" будет заменено на ".0-2".
...
console.log(decode(decodedInput));
